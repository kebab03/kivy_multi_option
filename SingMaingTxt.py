...
class CustomTextInput(TextInput):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.background_color = [0.2, 0.9, 0.9, 1]  # Light gray color
        self.foreground_color = [0, 0, 0, 1]  # Black text color
...
class MyApp(App):
    def build(self):
        ...
        # TextInput widget
        text_input = CustomTextInput(multiline=False)
